...
* fill files `zadX.py` corresponding to assignments in the `assignment.pdf` file and solve the problems! Be aware, there may be small differences since last time.
